...
export const initialCategoriesData: Category[] = [
  ...
  { id: 'cat-maanisha', name: 'Maanisha K.', image: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyMHx8Z2lybHxlbnwwfHx8fDE3NTAwOTY3ODR8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'woman creative designer indian', viewed: false, profileId: 'maanisha-k-profile' },
