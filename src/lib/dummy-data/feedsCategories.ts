...
export const initialCategoriesData: Category[] = [
  ...
  { id: 'cat-deepthi', name: 'Deepthi', image: 'https://images.unsplash.com/photo-1602233158242-3ba0ac4d2167?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxHaXJsfGVufDB8fHx8MTc1MDE1MTE2OXww&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'woman portrait indian', viewed: false, profileId: 'deepthi-profile' },
