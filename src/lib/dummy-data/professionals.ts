...
export const dummyProfessionalProfiles: IndividualProfessionalCardData[] = [
  {
    id: 'prof1',
    name: 'Jenson Harris',
    avatarUrl: 'https://source.unsplash.com/80x80/?man,smiling,professional',
    avatarAiHint: 'man smiling professional',
    professionalTitle: 'Interior Home Stylist',
    previewImages: [
      { url: 'https://source.unsplash.com/200x150/?modern,living,room', aiHint: 'modern living room' },
      { url: 'https://source.unsplash.com/200x150/?stylish,kitchen', aiHint: 'stylish kitchen' },
      { url: 'https://source.unsplash.com/200x150/?cozy,bedroom', aiHint: 'cozy bedroom' },
      { url: 'https://source.unsplash.com/200x150/?elegant,dining,area', aiHint: 'elegant dining area' },
    ],
  ...
  },
  {
    id: 'prof2',
    name: 'Alicia Keyson',
    avatarUrl: 'https://source.unsplash.com/80x80/?woman,architect',
    avatarAiHint: 'woman architect',
    professionalTitle: 'Lead UX Designer',
    previewImages: [
      { url: 'https://source.unsplash.com/200x150/?app,interface', aiHint: 'app interface' },
      { url: 'https://source.unsplash.com/200x150/?website,mockup', aiHint: 'website mockup' },
      { url: 'https://source.unsplash.com/200x150/?user,flow,diagram', aiHint: 'user flow diagram' },
    ],
  ...
  },
  {
    id: 'prof3',
    name: 'Marcus Cole',
    avatarUrl: 'https://source.unsplash.com/80x80/?man,plumber,tools',
    avatarAiHint: 'man plumber tools',
    professionalTitle: 'Master Plumber',
    previewImages: [
      { url: 'https://source.unsplash.com/200x150/?pipe,installation', aiHint: 'pipe installation' },
      { url: 'https://source.unsplash.com/200x150/?bathroom,fixture', aiHint: 'bathroom fixture' },
    ],
  ...
  },
  {
    id: 'prof4',
    name: 'Sophia Lorenza',
    avatarUrl: 'https://source.unsplash.com/80x80/?woman,graphic,designer',
