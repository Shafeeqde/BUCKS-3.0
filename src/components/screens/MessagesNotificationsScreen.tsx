...
const initialMessages: MessageItem[] = [
  { id: 1, sender: 'Shafeeq', senderImage: 'https://placehold.co/40x40.png', senderImageAiHint: 'man portrait', subject: 'Regarding your recent post', content: 'Hi, I saw your post about Diwali celebrations and wanted to share some thoughts...', timestamp: '2 hours ago', read: false },
  { id: 2, sender: 'Mikado UX UI', senderImage: 'https://placehold.co/40x40.png', senderImageAiHint: 'company logo', subject: 'Job Application Follow-up', content: 'Dear applicant, thank you for your interest in the Graphic Designer position...', timestamp: '5 hours ago', read: false },
  { id: 3, sender: 'Admin Support', senderImage: 'https://placehold.co/40x40.png', senderImageAiHint: 'support icon', subject: 'Welcome to Bucks!', content: 'Welcome to our platform! We are excited to have you on board.', timestamp: '1 day ago', read: true },
];
